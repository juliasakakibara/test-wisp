    ...
    <div className="fixed inset-0 flex bg-[#0f0f0f] font-mono overflow-hidden">
      ...
      <aside className="w-[300px] shrink-0 flex flex-col border-r border-white/10">
        ...
        <nav className="p-3 space-y-1 border-b border-white/10">
          ...
          >
            <Layout size={14} className="opacity-50 group-hover:opacity-100" />
            Tema (Visual)
            <ChevronRight size={10} className="ml-auto opacity-0 group-hover:opacity-100" />
          </Link>
          <Link 
            href="/admin/content" 
            className="flex items-center gap-3 px-3 py-2 rounded-md text-[11px] text-white bg-white/5 border border-white/10"
          >
